...
public class ReadingFromFile2 {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File file = new File("C:"+File.separator+"Projects"+File.separator+"MyTraining"+File.separator+"src"+File.separator+"Alishev"+File.separator+"basicjava"+File.separator+"ReadingFromFile"+File.separator+"Test2.txt");
